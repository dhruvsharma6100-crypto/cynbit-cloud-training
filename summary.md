...
1. URL Processing:-
The browser first examines the URL to determine the protocol, the domain name and the path to the requested resource.
...
The browser sends an HTTP request containing, request method, URL path and headers.
